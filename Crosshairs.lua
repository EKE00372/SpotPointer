...
local lineAlpha = 1 -- Set to 0 to hide lines but keep the circle
...
circle:SetTexture([[interface/addons/SpotPointer/Media/circle]])
circle:SetAllPoints()
...
tx:SetTexture([[interface/addons/SpotPointer/Media/arrows]])
tx:SetAllPoints()
--tx:SetPoint("CENTER")
--tx:SetSize(86, 86)
--tx:SetAlpha(0.5)
